...
import { useEditAuthorMutation } from "../../../mutation";

interface Props {
    author: Author;
}

export const EditAuthorForm = ({ author }: Props) => {
    const { mutate, isPending } = useEditAuthorMutation();
    ...
    const onSubmit = (data: AuthorSchemaType) => {
        mutate({ id: author.id, values: data });
    }
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Update author details.</CardDescription>
            </CardHeader>
            <CardContent>
                <Form {...form}>
